describe("js-functions", function() {
  ...
  it('returns a name', function() {
    expect(getStudentName({name: 'Michael', age: 27 })).toEqual("Michael");
  });
  ...
  it("takes two args and creates an object",function(){
  ...
  it("returns all key value pairs of an obj as a string joined by a supplied argument",function(){
    expect(outputObject("is", {john: 10, jerry: 11, jenny: 12 })).toEqual("john is 10, jerry is 11, jenny is 12");
  })
